...
public class PlayersMetricsHandler implements IMetricHandler {
    ...
    private static final IMetricProcessor HYRIPLUS_PLAYERS = () -> new HyriPlusPlayers(IMetricProcessor.fetch(HyreosRedisKey.HYRI_PLUS));
    private static final IMetricProcessor REGISTERED_PLAYERS = () -> new RegisteredPlayers(IMetricProcessor.fetch(HyreosRedisKey.REGISTERED_PLAYERS));
